...
using YunkuEntSDK.UtilClass.Reflection;
 ...
 static class SimpleJson
    {
        ...
        public static long TryLongValue(IDictionary<string, object> json, string key)
        {
            return Convert.ToInt64(GetValueOrDefault(json, key, 0));
        }

        public static long TryLongValue(IDictionary<string, object> json, string key, long defautValue)
        {
            return Convert.ToInt64(GetValueOrDefault(json, key, defautValue));

        }

        public static int TryIntValue(IDictionary<string, object> json, string key)
        {
            return Convert.ToInt32(GetValueOrDefault(json, key, 0));
        }

        public static int TryIntValue(IDictionary<string, object> json, string key, int defautValue)
        {
            return Convert.ToInt32(GetValueOrDefault(json, key, defautValue));
        }

        public static string TryStringValue(IDictionary<string, object> json, string key)
        {
            return (string)GetValueOrDefault(json, key, "");
        }

        public static JsonArray TryJsonArrayValue(IDictionary<string, object> json, string key)
        {
            return GetValueOrDefault(json, key, new JsonArray()) as JsonArray;
        }

        public static bool TryBoolValue(IDictionary<string, object> json, string key)
        {
            return Convert.ToBoolean(GetValueOrDefault(json, key, false));
        }

        public static bool TryBoolValue(IDictionary<string, object> json, string key, bool defautValue)
        {
            return Convert.ToBoolean(GetValueOrDefault(json, key, defautValue));
        }
